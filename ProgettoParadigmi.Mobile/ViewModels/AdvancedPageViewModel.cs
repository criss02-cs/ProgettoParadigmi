...
public class AdvancedPageViewModel : BaseViewModel
{
    ...
    public AdvancedPageViewModel() : base()
    {
        ...
        //     new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool"))
        //         { EventIndicatorColor = Colors.Blue, EventIndicatorSelectedColor = Colors.Blue });
        // Events.Add(DateTime.Now.AddDays(-4),
        //     new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool"))
        //         { EventIndicatorColor = Colors.Green, EventIndicatorSelectedColor = Colors.White });
        // Events.Add(DateTime.Now.AddDays(-5),
        //     new DayEventCollection<AdvancedEventModel>(GenerateEvents(10, "Cool"))
        //         { EventIndicatorColor = Colors.Orange, EventIndicatorSelectedColor = Colors.Orange });
